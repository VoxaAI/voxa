...
latex_documents = [
    (master_doc, 'voxa.tex', u'Voxa Documentation', u'Rain Agency', 'manual'),
]
...
man_pages = [(master_doc, 'voxa', u'Voxa Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'Voxa', u'Voxa Documentation', author, 'Voxa',
