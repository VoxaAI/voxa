...
AlexaSkill.prototype.requestHandlers = {
    LaunchRequest: function LaunchRequest(event, context, response) {
        this.eventHandlers.onLaunch.call(this, event.request, event.session, response, event.context);
    },
    ...
    'AudioPlayer.PlaybackNearlyFinished': function PlaybackNearlyFinishedRequest(event, context, response) {
