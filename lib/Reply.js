...
class Reply {
  ...
  append(msg) {
    ...
    this.msg.end = this.msg.end || !!(msg.ask || msg.tell);
  ...
  appendReply(reply) {
    ...
    this.msg.end = this.msg.end || reply.msg.end;
  ...
  hasDirective(type) {
    return this.msg.directives.some(directive => {
      ...
      else throw new Error(`Do not now how to use a ${typeof type} to find a directive`);
    })
  }

  isYielding() {
    return this.msg.end || this.hasDirective(/^Dialog\./);
  }
