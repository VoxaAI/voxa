...
class Reply {
  ...
  append(msg) {
    ...
    this.msg.hint = msg.hint || this.msg.hint;
    ...
    msg.supportDisplayInterface = hasSupportForDisplay(this.alexaEvent);
  ...
  appendReply(reply) {
    ...
    reply.supportDisplayInterface = hasSupportForDisplay(this.alexaEvent);
    this.msg.hint = reply.msg.hint || this.msg.hint;
...
function cannonicalizeDirectives(alexaEvent, msg) {
  ...
  if (msg.hint && msg.supportDisplayInterface) {
    directives = directives
      .filter(directive => directive.type !== 'Hint')
      .concat({
        type: 'Hint',
        hint: {
          type: 'PlainText',
