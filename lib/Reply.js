...
class Reply {
  constructor(alexaEvent, msg) {
    ...
    this.msg = {
      ...
      terminate: false, // The conversation is over
      directives: [],
    };
    this.append(msg);
  }
  ...
  append(msg) {
    ...
    this.msg.terminate = this.msg.terminate || !!msg.tell;
    this.msg.yield = this.msg.yield || !!(msg.ask || msg.tell) || this.msg.terminate;
  ...
  appendReply(reply) {
    ...
    this.msg.terminate = this.msg.terminate || reply.msg.terminate;
  ...
  toJSON() {
    ...
    const alexaResponse = {
      ...
      shouldEndSession: !!this.msg.terminate,
      card: this.msg.card,
    };
