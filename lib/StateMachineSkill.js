...
StateMachineSkill.prototype.eventHandlers.onLaunch = function (launchRequest,
  session,
  response) {
  var _this = this;
...
StateMachineSkill.prototype.eventHandlers.onSessionEnded = function (sessionEndedRequest,
  session) {
  var _this = this;
  if (_this._config.verbose)
...
StateMachineSkill.prototype.eventHandlers.onIntent = function (request,
  session,
  response) {
  var _this = this;
...
function analytics(request) {
  return universalAnalytics(config.googleAnalytics.trackingCode,
    request.session.user.userId,
    { strictCidFormat: false });
}
