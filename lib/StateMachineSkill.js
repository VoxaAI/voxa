...
StateMachineSkill.prototype.eventHandlers.onLaunch = function (launchRequest, session, response, context) {
  var _this = this;
...
StateMachineSkill.prototype.eventHandlers.onIntent = function (request, session, response, context) {
  var _this = this;
  ...
  return stateMachine.transition(request).then(function (trans) {
...
StateMachineSkill.prototype.eventHandlers.onPlaybackStarted = function (playBackRequest, response) {
  var _this = this;
  if (_this._config.verbose) console.log('onPlaybackStarted requestId: ' + playBackRequest.request.requestId);
...
StateMachineSkill.prototype.eventHandlers.onPlaybackFinished = function (playBackRequest, response) {
  var _this = this;
  if (_this._config.verbose) console.log('onPlaybackFinished requestId: ' + playBackRequest.request.requestId);
...
StateMachineSkill.prototype.eventHandlers.onPlaybackNearlyFinished = function (playBackRequest, response) {
  var _this = this;
  if (_this._config.verbose) console.log('onPlaybackNearlyFinished requestId: ' + playBackRequest.request.requestId);
...
StateMachineSkill.prototype.eventHandlers.onPlaybackStopped = function (playBackRequest, response) {
  var _this = this;
  if (_this._config.verbose) console.log('onPlaybackStopped requestId: ' + playBackRequest.request.requestId);
...
StateMachineSkill.prototype.eventHandlers.onPlaybackFailed = function (playBackRequest, response) {
  var _this = this;
  if (_this._config.verbose) console.log('onPlaybackFailed requestId: ' + playBackRequest.request.requestId);
...
var replyWithAudioDirectives = module.exports.replyWithAudioDirectives = function (msgPath, state, request, data, directives) {
  var _this = this;
  if (verbose) console.log('Move to state [' + state + '] and say ' + msgPath);
  return renderMessage(msgPath, data).then(function (msg) {
    // For AMAZON.RepeatIntent
