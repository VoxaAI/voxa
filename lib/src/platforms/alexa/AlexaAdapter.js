...
var AlexaAdapter = /** @class */ (function (_super) {
    ...
    function AlexaAdapter(voxaApp) {
        ...
        _this.app.onAfterStateChanged(function (voxaEvent, reply, transition) { return AlexaAdapter.partialReply(voxaEvent, reply, transition); });
     ...
     */
    AlexaAdapter.partialReply = function (event, reply, transition) {
