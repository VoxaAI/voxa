...
var log = debug("voxa");
var cortanalog = debug("voxa:cortana");
var CortanaRequests = [
    "conversationUpdate",
...
var CortanaAdapter = /** @class */ (function (_super) {
    ...
    function CortanaAdapter(voxaApp, config) {
        ...
        _.map([directives_1.HeroCard, directives_1.AudioCard, directives_1.SuggestedActions], function (handler) { return voxaApp.registerDirectiveHandler(handler, handler.name); });
        return _this;
    }
    /*
    ...
    CortanaAdapter.prototype.execute = function (msg, context) {
        return __awaiter(this, void 0, void 0, function () {
            var stateData, intent, event, reply;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3:
                        reply = _a.sent();
                        return [4 /*yield*/, this.partialReply(event, reply, {})];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, this.saveStateData(event, reply)];
                    case 5:
                        _a.sent();
                        return [2 /*return*/, {}];
                }
                        ...
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                ...
                                if (msg.text) {
                                    return botbuilder_1.LuisRecognizer.recognize(msg.text, _this.config.recognizerURI, function (err, intents, entities) {
                                        ...
                                        cortanalog({ intents: intents, entities: entities });
