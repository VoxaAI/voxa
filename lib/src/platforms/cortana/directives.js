        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    _a.label = 3;
                case 3:
                    reply.response.directives.push({ type: "attachment", attachment: attachment });
                    return [2 /*return*/];
            }
        });
    }); };
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, reply.render(templatePath)];
                case 1:
                    suggestedActions = _a.sent();
                    return [3 /*break*/, 3];
                case 2:
                    suggestedActions = templatePath;
                    _a.label = 3;
                case 3:
                    reply.response.directives.push({ type: "suggestedActions", suggestedActions: suggestedActions });
                    return [2 /*return*/];
            }
        });
    }); };
...
function AudioCard(url, title, profile) {
    var _this = this;
    if (title === void 0) { title = ""; }
    if (profile === void 0) { profile = ""; }
    return function (reply, event) { return __awaiter(_this, void 0, void 0, function () {
        var attachment, cardMedia;
        return __generator(this, function (_a) {
            attachment = new botbuilder_1.AudioCard();
            attachment.title(title);
            cardMedia = { url: url, profile: profile };
...
function isAttachment(object) {
    return "contentType" in object;
}
exports.isAttachment = isAttachment;
function isSuggestedActions(object) {
