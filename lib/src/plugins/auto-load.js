...
var log = debug("voxa:plugins:autoload");
var defaultConfig = {};
function autoLoad(skill, config) {
    ...
    skill.onSessionStarted(function (voxaEvent) { return __awaiter(_this, void 0, void 0, function () {
        var data, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, defaultConfig.adapter.get(voxaEvent.user)];
                case 1:
                    data = _a.sent();
                    log("Data fetched:");
                    log(data);
                    voxaEvent.model.user = data;
                    return [2 /*return*/, voxaEvent];
                case 2:
                    error_1 = _a.sent();
                    log("Error getting data: " + error_1);
                    throw error_1;
