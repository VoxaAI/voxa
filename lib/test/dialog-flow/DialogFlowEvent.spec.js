...
describe("DialogFlowEvent", () => {
    it("should format option values", () => {
        const event = new DialogFlowEvent_1.DialogFlowEvent(optionIntent, {});
    ...
    it("should format dialogflow parms", () => {
        const event = new DialogFlowEvent_1.DialogFlowEvent(slotsIntent, {});
    ...
    it("should find users on the session", () => {
        const event = new DialogFlowEvent_1.DialogFlowEvent(launchIntent, {});
        /* tslint:disable-next-line:max-line-length */
        chai_1.expect(event.user.userId).to.equal("ABwppHG14A5zlHSo4Q6CMw3IHD6a3UtYXEtEtcrDrQwBOWKO95VRm-rL-DdhbzDeHXUXiwpDcrDAzY19C8Y");
    });
    ...
    it("should return the MEDIA_STATUS information", () => {
        const event = new DialogFlowEvent_1.DialogFlowEvent(mediaStatusIntent, {});
    ...
    it("should return the SIGN_IN information", () => {
        const event = new DialogFlowEvent_1.DialogFlowEvent(signinIntent, {});
        chai_1.expect(event.intent.params).to.deep.equal({
            SIGN_IN: {
    ...
    it("should return the correct intent", () => {
        const event = new DialogFlowEvent_1.DialogFlowEvent(helpIntent, {});
    ...
    it("should extract the correct parameters from a permissionIntent", () => {
        const event = new DialogFlowEvent_1.DialogFlowEvent(permissionIntent, {});
        chai_1.expect(event.intent.params).to.deep.equal({
            KEYBOARD: "yes",
            PERMISSION: true,
        });
        chai_1.expect(event.user.permissions).to.deep.equal(["NAME"]);
    });
    it("should extract the correct parameters from a datetimeIntent", () => {
        const event = new DialogFlowEvent_1.DialogFlowEvent(datetimeIntent, {});
        chai_1.expect(event.intent.params).to.deep.equal({
            DATETIME: {
                date: {
                    day: 8,
    ...
    it("should extract the correct parameters from a confirmationIntent", () => {
        const event = new DialogFlowEvent_1.DialogFlowEvent(placeIntent, {});
        chai_1.expect(event.intent.params).to.deep.equal({
    ...
    it("should extract the NEW_SURFACE confirmationIntent", () => {
        const event = new DialogFlowEvent_1.DialogFlowEvent(newSurfaceIntent, {});
        chai_1.expect(event.intent.params).to.deep.equal({
            NEW_SURFACE: {
