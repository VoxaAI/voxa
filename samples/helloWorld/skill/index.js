...
var alexa = require('alexa-statemachine'), sm = require('./MainStateMachine'), appId = require('../config').alexa.appId, responses = require('./responses'), variables = require('./variables')
  ;
